...
if __name__ == "__main__":
    ...
    if os.environ.get("RENDER"):
        ...
        if bot_token:
            ...
            # Initialize application synchronously for webhook processing
            import asyncio
            ...
            try:
                ...
                loop.close()
                logger.info("Application initialized successfully for webhook mode")
            except Exception as e:
                logger.error(f"Failed to initialize application: {e}")
            
            # Add webhook endpoint with simplified processing
            ...
            def webhook():
                ...
                try:
                    ...
                    # Process update with new event loop (simpler approach)
                    import asyncio
                    loop = asyncio.new_event_loop()
                    asyncio.set_event_loop(loop)
                    try:
